...
<div class='dashboard'>
	<div class='dashboard_head'>
		<p style='font-family:museo'><a href='<?= site_url('Purchasing') ?>' title='Purchasing'><i class='fa fa-shopping-cart'></i></a> /Purchase Order /Create</p>
	</div>
	<br>
	<div class='dashboard_in'>
		<form action='<?= site_url('Purchase_order/insertItem') ?>' method='POST' id='purchase_order_form'>
			...
			<button type='button' class='button button_default_dark' id='submit_button' onclick='show_purchase_order()' style='display:none'><i class='fa fa-long-arrow-right'></i></button>
		</form>
	</div>
</div>
...
<script>
	...
	function openSupplierView(){
		$('#supplierSearchBar').val("");
		$('#supplier_wrapper').fadeIn();
		refreshSupplier(1);
	}
