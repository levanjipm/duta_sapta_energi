...
?>
		<tr>
			...
			<td>
				<button type='button' class='button button_default_dark' onclick='show_purchase_order_detail(<?= $id ?>)'><i class='fa fa-eye'></i></button>
			</td>
		</tr>
<?php
	}
	...
	<div class='alert_wrapper' id='purchase_order_detail_wrapper'>
		...
		<div class='alert_box_slide'>
			...
			<form action='<?= site_url('Purchase_order/confirm') ?>' method='POST'>
				...
				<button type='button' class='button button_danger_dark' style='display:inline-block' onclick='delete_purchase_order()'><i class='fa fa-trash'></i></button>
			</form>
		</div>
	</div>
