		...
		<div class="row" style="padding-top:20px">
			<div class="col-sm-6 col-xs-12">
				<div class="row">
					...
					<div class='col-xs-12'>
						<button class='button button_info' onclick='window.location.href="<?= site_url('Receivable') ?>"' title="Go to receivable"><i class='fa fa-info'></i></a>
					</div>
				</div>
			</div>
			<div class="col-sm-6 col-xs-12">
				<div class="row">
					...
					<div class='col-xs-12'>
						<button class='button button_info' onclick='window.location.href="<?= site_url('Payable') ?>"' title="Go to payable"><i class='fa fa-info'></i></a>
					</div>
				</div>
			</div>
		</div>
