...
<div class='dashboard'>
	<div class='dashboard_head'>
		<p style='font-family:museo'><a href='<?= site_url('Sales') ?>' title='Sales'><i class='fa fa-line-chart'></i></a> / Create Visit List   </p>
	</div>
	<br>
...
<script>
	...
	$('#createBillingButton').click(function(){
		if($('#createBillingForm').valid()){
			window.location.href='<?= site_url('Visit_list/createForm') ?>' + "?date=" + $('#date').val() + "&sales=" + $('#sales').val();
		}
	})
