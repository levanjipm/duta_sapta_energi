...
<div class='dashboard'>
	...
	<div class='dashboard_in'>
		...
		<div style='text-align:center'>
			...
			<h3 style='font-family:bebasneue'>Customer's plafond successfully changed.</h3>
			<label>Plafond</label>
			<p style='font-family:museo'><strong>Rp. <?= number_format($submission->submitted_plafond,2) ?></strong></p>
...
<div class='dashboard'>
	...
	<div class='dashboard_in'>
		...
		<br>
		<div style='text-align:center'>
			<h3 style='font-family:bebasneue'>Customer's plafond failed to change.</h3>
