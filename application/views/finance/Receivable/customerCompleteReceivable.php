...
<div class='dashboard'>
	<div class='dashboard_head'>
		<p style='font-family:museo'><a href='<?= site_url('Finance') ?>' title='Accounting'><i class='fa fa-briefcase'></i></a> /<a href='<?= site_url('Receivable/finance') ?>'>Receivable</a> / <?= $customerName ?></p>
	</div>
	<br>
